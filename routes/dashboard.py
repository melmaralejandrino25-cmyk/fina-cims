...
def dashboard():
    ...
    if search:
        ...
        search_results = db.execute(
            ...
            WHERE f.rsbsa LIKE ? OR f.last_name LIKE ? OR f.first_name LIKE ?
    ...
    total_farmers = wet_farmer + dry_farmer
    total_assoc = wet_assoc + dry_assoc
    total_area = round(wet_area + dry_area, 2)
    total_mt = round(wet_mt + dry_mt, 2)
    total_muni = max(wet_muni, dry_muni)

    avg_yield = round(total_mt / total_area, 2) if total_area else 0
    avg_prod_farmer = round(total_mt / total_farmers, 2) if total_farmers else 0
    avg_area_farmer = round(total_area / total_farmers, 2) if total_farmers else 0

    highest_production_municipality = highest_production_dry["municipality"]
    highest_yield_municipality = highest_yield_dry["municipality"]
    largest_area_municipality = largest_area_dry["municipality"]
    ...
    return render_template(
        ...
        wet_farmers=wet_farmer,
        dry_farmers=dry_farmer,
        ...
        total_mt=total_mt,
        avg_yield=avg_yield,
        avg_prod_farmer=avg_prod_farmer,
        avg_area_farmer=avg_area_farmer,
        ...
        highest_production_municipality=highest_production_municipality,
        highest_yield_municipality=highest_yield_municipality,
        largest_area_municipality=largest_area_municipality,
